// Generated from d:/B7/B7.ISO20022/B7.ISO20022/Simpra/AltaSoft.Simpra/G4/SimpraLexer.g4 by ANTLR 4.13.1
...
public class SimpraLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"PERCENT", "ON_OFF", "NULL", "WS", "LET", "WHEN", "IF", "THEN", "ELSE", 
			"END", "RETURN", "IS", "IS_NOT", "NOT_IN", "IN", "NOT", "MIN", "MAX", 
			"MATCHES", "LIKE", "HAS", "VALUE", "AND", "OR", "EQ", "PLUS", "MINUS", 
			"MULT", "DIV", "IDIV", "LT", "LE", "GT", "GE", "LPAREN", "RPAREN", "LBRACK", 
			"RBRACK", "COMMA", "DOT", "IDENTIFIER", "DIRECTIVE", "ERROR"
		};
	}
	...
	public SimpraLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "SimpraLexer.g4"; }
